...
from agent.agent.message_manager.views import MessageManagerState
from agent.browser.views import BrowserStateHistory
from agent.dom.views import DEFAULT_INCLUDE_ATTRIBUTES, DOMInteractedElement, DOMSelectorMap

# from agent.dom.history_tree_processor.service import (
# 	DOMElementNode,
# 	DOMHistoryElement,
# 	HistoryTreeProcessor,
# )
# from agent.dom.views import SelectorMap
from agent.llm.base import BaseChatModel
from agent.tokens.views import UsageSummary
...
class AgentState(BaseModel):
	...
	modal_click_failures: int = 0  # Счетчик неудачных попыток клика в модальном окне
...
class AgentHistoryList(BaseModel, Generic[AgentStructuredOutput]):
	...
	# 	"""
	# 	from agent.agent.playwright_script_generator import PlaywrightScriptGenerator
