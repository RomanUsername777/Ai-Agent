...
from agent.actor.utils import get_key_info
...
from agent.browser.views import BrowserError, URLNotAllowedError
...
class DefaultActionWatchdog(BaseWatchdog):
	...
	async def _handle_print_button_click(self, element_node: EnhancedDOMTreeNode) -> dict | None:
		...
		try:
			...
			from agent.browser.events import FileDownloadedEvent
